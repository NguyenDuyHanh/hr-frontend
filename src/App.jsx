...
import SalaryItemPage from "./pages/Salary/salary-items/SalaryItemPage";
import StaffSalaryConfigList from "./pages/Salary/staff-salary-config/StaffSalaryConfigList";
import SalaryPeriodPage from "./pages/Salary/periods/SalaryPeriodPage";
import PayrollListPage from "./pages/Salary/payroll/PayrollListPage";
import PayrollDetailPage from "./pages/Salary/payroll/PayrollDetailPage";
import StaffPayslipPage from "./pages/Salary/my-payslip/StaffPayslipPage";

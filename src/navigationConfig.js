...
export const navigations = [
  ...
  },
  {
    ...
    children: [
      { name: "Yêu cầu tuyển dụng", path: "/recruitment-request-v2", auth: [ADMIN, HR_MANAGER, HR_RECRUITMENT] },
      { name: "Kế hoạch tuyển dụng", path: "/recruitment-plan-v2", auth: [ADMIN, HR_MANAGER, HR_RECRUITMENT] },
      { name: "Hồ sơ ứng viên", path: "/candidate", auth: [ADMIN, HR_MANAGER, HR_RECRUITMENT] },
    ],
  },
  {
    name: "Nhân viên",
